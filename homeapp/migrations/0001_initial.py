# Generated by Django 4.2.7 on 2024-01-14 14:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_total', models.IntegerField(blank=True, default=100, null=True)),
                ('available_quantity', models.IntegerField(blank=True, default=100, null=True)),
                ('classname', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='homeapp.classname')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homeapp.student')),
                ('textbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homeapp.textbook')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='student',
            name='textbooks',
            field=models.ManyToManyField(blank=True, to='homeapp.textbook'),
        ),
        migrations.AddField(
            model_name='student',
            name='username',
